...
func reposition(res):
    var vb1 = get_node("MarginContainer/VBoxContainer")
    vb1.AddThemeConstantOverride("separation", (int)(res.y/1080*70))
    var vb2 = get_node("MarginContainer/HBoxContainer/VBoxContainer")
    vb2.AddThemeConstantOverride("separation", (int)(res.y/1080*20))
    var vb3 = get_node("MarginContainer/HBoxContainer2/VBoxContainer")
    vb3.AddThemeConstantOverride("separation", (int)(res.y/1080*20))
    var hb1 = get_node("MarginContainer/HBoxContainer")
    hb1.AddThemeConstantOverride("separation", (int)(res.x/1920*150))
    var hb2 = get_node("MarginContainer/HBoxContainer2")
    hb2.AddThemeConstantOverride("separation", (int)(res.x/1920*300))
