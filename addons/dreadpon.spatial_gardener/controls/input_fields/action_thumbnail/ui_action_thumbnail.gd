...
func _ready():
	...
	if has_node("CounterContainer"):
		...
		counter_label_nd.add_theme_font_override('font', get_font("font", "Label").duplicate())
	...
	if has_node("AltTextMargin"):
		...
		alt_text_label_nd.add_theme_font_override('font', get_font("font", "Label").duplicate())
	...
	if has_node('LabelLineEdit'):
		...
		label_line_edit_nd.add_theme_font_override('font', get_font("font", "Label").duplicate())
