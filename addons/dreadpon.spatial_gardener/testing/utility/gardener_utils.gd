...
static func populate_node_with_surfaces(parent_node:Node, landscape_surface:bool = true, plane_surfaces:bool = true) -> Array:
	...
	if plane_surfaces:
		painting_data.append_array([
			PaintBodyData.new("plane", Vector3(120, 0, 120), Basis(Quaternion(Vector3(PI/4, PI/4, 0))), 10.0),
			PaintBodyData.new("plane", Vector3(-120, 0, 120), Basis(Quaternion(Vector3(PI/2, 7*PI/4, 0))), 13.33),
			PaintBodyData.new("plane", Vector3(120, 0, -120), Basis(Quaternion(Vector3(7*PI/4, 3*PI/4, 0))), 16.66),
			PaintBodyData.new("plane", Vector3(-120, 0, -120), Basis(Quaternion(Vector3(PI, 5*PI/4, 0))), 20.0)])
